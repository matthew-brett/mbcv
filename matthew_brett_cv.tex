...
mathematics to describe imaging staistics in standard terrms, including
...
{Third-ranked developer by code commits.  Python package for analysis of
    diffusion MRI data.  In total project has 69 contributors; 43,806 lines of
code; estimated 11 years of developer effort
...
of functional MRI data. In total: 59 contributors; 69,522 lines of code;
estimated 18 years of developer effort
...
{Lead developer and maintainer. Reads and writes standard neuroimaging file
    formats.  In total: 46 contributors; 28,473 lines of code; estimated 7
years of developer effort \footnote{\url{https://www.openhub.net/p/nibabel}}.
...
{Lead developer and maintainer. Region of interest analysis for functional
    imaging data.  In total: 3 contributors; 22,166 lines of code; estimated 6
    years of developer effort
    \footnote{\url{https://www.openhub.net/p/marsbar}}.  MarsBaR abstrct has
been cited 2127 times as of July 2016.}
